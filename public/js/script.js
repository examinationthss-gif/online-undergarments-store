...
function initWhatsAppFloatingButton() {
  ...
  if (document.getElementById('whatsapp-floating-container')) return;

  const container = document.createElement('div');
  container.id = 'whatsapp-floating-container';
  ...
  container.innerHTML = `
    ...
    <div class="whatsapp-chat-box" id="whatsapp-chat-box">
      <div class="whatsapp-box-header">
        <div class="whatsapp-header-info">
          <div class="whatsapp-avatar">US</div>
          <div class="whatsapp-header-text">
            <h4>USTORE Support</h4>
            <p>Typically replies in minutes</p>
          </div>
        </div>
        <button class="whatsapp-close-btn" id="whatsapp-close-btn" aria-label="Close Chat">✕</button>
      </div>
      <div class="whatsapp-box-body">
        <div class="whatsapp-msg">
          <p>Hi there! 👋 Welcome to USTORE. Feel free to ask us any questions about our products, sizes, or shipping! How can we help you today?</p>
          <span class="whatsapp-msg-time">${new Date().toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
        </div>
      </div>
      <div class="whatsapp-box-footer">
        <div class="whatsapp-input-container">
          <input type="text" class="whatsapp-input" id="whatsapp-user-message" placeholder="Type your message here..." aria-label="Type message for WhatsApp">
          <button class="whatsapp-send-btn" id="whatsapp-send-btn" aria-label="Send to WhatsApp">
    ...
    <button class="whatsapp-btn" id="whatsapp-toggle-btn" aria-label="Contact support on WhatsApp">
  ...
  const handleSend = () => {
    ...
    const message = text ? encodeURIComponent(text) : encodeURIComponent("Hi USTORE support! I'm interested in your premium comfort innerwear products.");
